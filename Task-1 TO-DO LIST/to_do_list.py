...
if __name__ == "__main__":
    ...
    # Change icon
    image_icon = PhotoImage(file = "TASK-1 TO- DO LIST/Image/task.png")
    ...
    dockImage = PhotoImage(file = "TASK-1 TO- DO LIST/Image/Doc (2).png")
    Label(root,image = dockImage).place(x=30,y=13)
    ...
    btn_add_task = Button(root, text='Add task', width=20,
                          command=addTask, relief=RIDGE,bg="skyblue")
    btn_del_one = Button(root, text='Delete', width=20,
                         relief=RIDGE, command=delOne,bg="#F88379")
    btn_del_all = Button(root, text='Delete all', width=20,
                         relief=RIDGE, command=deleteAll,bg="#FF5359")
    btn_exit = Button(root, text='Exit', width=20, relief=RIDGE, command=exit,bg="red")
    ...
    # delte_icon = PhotoImage(file = "TASK-1 TO- DO LIST/Image/delete (1).png")
    # Button(root,image = delte_icon,bd=0).pack(side=BOTTOM,pady=13)
